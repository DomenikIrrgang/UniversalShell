...
import universalshell.graphlib.GraphLibCommandFactory;
...
public class MultiplexerShell {
    ...
    public static void main(String[] args) {
        UniversalShell shell = new UniversalShell(new InputStreamInput(System.in), new OutputStreamOutput(System.out));
        CommandFactory factory = new GraphLibCommandFactory(shell);
        shell.run(factory);
    }

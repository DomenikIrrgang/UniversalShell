...
/**
 * Shell that can run a program based on a CommandFactory and provides means to retrieve input
 * and create output.
 *
 * @author Marc Bambey
 */
public class UniversalShell {
     ...
     * 
     * @param input Input that will be used by the program to retrieve input from the user.
